...
## AI helper / Copilot guidance

This repository includes GitHub Copilot guidance in `.github/copilot.yml` and a Copilot SDK skill at `skills/angular-upgrade/SKILL.md`.

For upgrade-specific AI support, this repo also includes a custom agent profile at `.github/agents/angular-upgrade.md`.

Use the skill directory for Copilot SDK skill loading and the agent profile if you want a custom cloud agent that preloads the upgrade skill.
